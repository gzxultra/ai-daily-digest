          ...
          <div>
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-6 max-w-lg">
                {lang === "zh"
                  ? `${date} — 精选 ${newsCount} 条最重要的 AI 新闻，涵盖全球治理、投资动态、安全研究、产品发布等领域。`
                  : `${date} — ${newsCount} curated top AI stories covering global governance, investments, safety research, product launches, and more.`}
              </p>
